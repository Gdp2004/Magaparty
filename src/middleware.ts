...
export function middleware(request: NextRequest) {
  ...
  // CSP Header
  // Note: Adjust the domains if you use external scripts (e.g. Google Maps, Stripe)
  const cspHeader = `
    default-src 'self';
    ...
    img-src 'self' blob: data: https://*.supabase.co https://images.unsplash.com https://wa.me;
