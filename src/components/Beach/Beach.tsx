...
export function Beach() {
  return (
    <section className={`section ${styles.beachSection}`} id="beach">
      <div className="container">
        <div className="section-header reveal">
          <span className="section-tag">La Nostra Spiaggia</span>
          <h2>Il Tuo Angolo di Paradiso</h2>
          <p className="section-subtitle">
            Un'esperienza balneare esclusiva pensata per il comfort di tutta la famiglia, 
            con servizi premium e la sicurezza al primo posto.
          </p>
        </div>
        
        <div className={styles.beachGrid}>
          <div className={`${styles.beachCard} reveal delay-1`}>
            <div className={styles.beachCardIcon}>
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--accent)' }}>
                <path d="M17.5 21H6.5c-.4 0-.7-.2-.8-.5L3 12.5c-.1-.3 0-.7.3-.9l8-5.5a1 1 0 0 1 1.4 0l8 5.5c.3.2.4.6.3.9l-2.7 8c-.1.3-.4.5-.8.5z"/>
                <path d="M12 2v4"/>
                <path d="M4.5 13.5h15"/>
              </svg>
            </div>
          ...
          <div className={`${styles.beachCard} reveal delay-2`}>
            <div className={styles.beachCardIcon}>
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--accent)' }}>
          ...
          <div className={`${styles.beachCard} reveal delay-3`}>
            <div className={styles.beachCardIcon}>
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--accent)' }}>
        ...
        <div className={`${styles.beachFeatureImg} reveal-scale`}>
